            ...
            <div class="card-body">
              ...
              <form class="forms-sample" method="POST" action="/modul/moduladvanced/{{$moduladvanced->id}}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="level" name="level" value="{{$moduladvanced->level}}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="tingkat-sekolah" name="tingkat_sekolah" value="{{$moduladvanced->tingkat_sekolah}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" placeholder="Masukkan Judul Modul" name="judul_modul" value="{{$moduladvanced->judul_modul}}" required>
                </div>
                <div class="form-group">
                  <label for="exampleTextarea1">Deskripsi Modul</label>
                  <textarea class="form-control" id="description" rows="4" name="deskripsi_modul"><?php echo $moduladvanced['deskripsi_modul'] ?></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleTextarea1">Tantangan</label>
                  <textarea class="form-control" id="task" rows="4" name="tantangan"><?php echo $moduladvanced['tantangan'] ?></textarea>
                </div>
                <div class="form-group">
                  <label>Upload URL Video</label>
                  <input type="text" class="file-upload-default" name="url_video" value="{{$moduladvanced->url_video}}">
                  <div id="field_url_video" >

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" name="url_video" id="video_0" value="{{$moduladvanced->url_video}}" class="form-control file-upload-info" placeholder="Masukkan URL Video">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url_dokumen" class="file-upload-default" value="{{$moduladvanced->url_dokumen}}">
                  <div id="field_url_document">

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" name="url_dokumen" id="document_0" value="{{$moduladvanced->url_dokumen}}" class="form-control file-upload-info" placeholder="Masukkan URL Dokumen">
                    <span class="input-group-append">
                ...
                <div class="form-group">
                  ...
                  <div id="field_url_image" value="{{$moduladvanced->url_gambar}}">

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" value="{{$moduladvanced->url_gambar}}" name="url_gambar" id="document_0" class="form-control file-upload-info" placeholder="Masukkan URL Dokumen">
                    <span class="input-group-append">
                      <button class="file-upload-browse btn btn-primary" type="button" id="add_document">Upload</button>
                    </span>
                  </div>
