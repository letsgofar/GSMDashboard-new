    ...
    <div class="content-wrapper">
      <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Edit Modul Materi</h4>
              <p class="card-description">
                Admin bisa membuat mengedit materi dengan mengisi atau mengubah form berikut
              </p>
              <form class="forms-sample" method="POST" action="/modul/modulspesial/{{$modulspesial->id}}">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="level" name="level" value="{{$modulspesial->level}}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="tingkat-sekolah" name="tingkat_sekolah" value="{{$modulspesial->tingkat_sekolah}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" placeholder="Masukkan Judul Modul" name="judul_modul" value="{{$modulspesial->judul_modul}}" required>
                </div>
                <div class="form-group">
                  <label for="exampleTextarea1">Deskripsi Modul</label>
                  <textarea class="form-control" id="description" rows="4" name="deskripsi_modul"><?php echo $modulspesial['deskripsi_modul'] ?></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleTextarea1">Tantangan</label>
                  <textarea class="form-control" id="task" rows="4" name="tantangan"><?php echo $modulspesial['tantangan'] ?></textarea>
                </div>
                <div class="form-group">
                  <label>Upload URL Video</label>
                  <input type="text" class="file-upload-default" name="url_video" value="{{$modulspesial->url_video}}">
                  <div id="field_url_video" >

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" name="url_video" id="video_0" value="{{$modulspesial->url_video}}" class="form-control file-upload-info" placeholder="Masukkan URL Video">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url_dokumen" class="file-upload-default" value="{{$modulspesial->url_dokumen}}">
                  <div id="field_url_document">

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" name="url_dokumen" id="document_0" value="{{$modulspesial->url_dokumen}}" class="form-control file-upload-info" placeholder="Masukkan URL Dokumen">
                    <span class="input-group-append">
                ...
                <div class="form-group">
                  ...
                  <div id="field_url_image" value="{{$modulspesial->url_gambar}}">

                  </div>
                  <div class="input-group col-xs-12">
                    <input type="text" value="{{$modulspesial->url_gambar}}" name="url_gambar" id="document_0" class="form-control file-upload-info" placeholder="Masukkan URL Dokumen">
                    <span class="input-group-append">
                      <button class="file-upload-browse btn btn-primary" type="button" id="add_document">Upload</button>
                    </span>
                  </div>
