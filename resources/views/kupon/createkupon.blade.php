        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" name="add_kupon_form" id="add_kupon_form" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-4">
                      <div class="form-check">
                        <label for="inlineRadio1" class="form-check-label">
                          <input autocomplete="off" onclick="selectedKategori()" type="radio" class="form-check-input" id="inlineRadio1" value="date" name="radioInline">
                          Date
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-check">
                        <label for="inlineRadio2" class="form-check-label">
                          <input autocomplete="off" onclick="selectedKategori()" type="radio" class="form-check-input" id="inlineRadio2" value="kuota" name="radioInline">
                          Kuota
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group" id="rangeDate" style="display:none;">
                          <label for="">Date (contoh: 20-12-2019)</label>
                              <input type="text" class="form-control" name="expired_date" placeholder="dd-mm-yyyy">
                      </div>
                      </div>
                      <div class="col-sm-5">
                        <div class="form-group" id="kuotaView" style="display:none;">
                            <label for="">Kuota</label>
                                <input type="text" class="form-control" id="coupon_quota" name="coupon_quota" placeholder="Masukkan Kuota" required>
                        </div>
                    </div>
                  </div>
                  
                <button class="btn btn-primary mr-2" id="add_kupon" onclick="add_kupon()">Buat Kupon</button>
              </form>
            </div>
          </div>
        </div>
